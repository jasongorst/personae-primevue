...
trix-editor {
  ...
  px-3 py-2
  text-surface-700 shadow-[0_1px_2px_0_rgba(18,18,23,0.05)]
  outline-hidden transition-colors
  duration-200 placeholder:text-surface-500 enabled:hover:border-surface-400
  enabled:focus:border-primary disabled:bg-surface-200
  ...
  p-invalid:placeholder:text-red-600 dark:p-invalid:border-red-300 dark:p-invalid:placeholder:text-red-400
